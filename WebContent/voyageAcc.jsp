...
<title>Voyages accompagnés</title>
...
<%@ include file="menu.jsp" %>	
 		...
 		<h2 style="font-size:30px; margin:8px auto auto auto; text-align:center; color: #394B88;">Les voyages accompagnés</h2><br>
		...
		<c:if test="${t.getType() == 'Accompagne' }">	
 			<tr>	
				...
				<td style="text-align: center;"><a href="Controller?page=addtocart&action=accom&id=<c:out value="${t.getId()}"/>&email=<c:out value="${email}"/>"><img style="width:45px;height :45px;"src="img/addCart.png"></a> <td>				
		 	</tr>
	 	</c:if>		
 		</c:forEach>
 	</table>
